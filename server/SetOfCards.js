...
class SetOfCards {
    ...
    static dummySet(count, maxCount) {
    ...
    containsCards(targets, meldCards) {
    ...
    containsOneOfEach(targets, meldCards) {
        let tmp = new SetOfCards(15);
        let cardsMissing = targets.length;
    ...
    isHigherCard(cardPlayed, highestCard, trump) {
        if (highestCard === null) {
            return true;
